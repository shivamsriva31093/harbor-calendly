...
set CLASSPATH=%APP_HOME%\lib\calendly-apis-1.0.0-SNAPSHOT-fat.jar

@rem Execute calendly-apis
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CALENDLY_APIS_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CALENDLY_APIS_EXIT_CONSOLE%" exit 1
exit /b 1
